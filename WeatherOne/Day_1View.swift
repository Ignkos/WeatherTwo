        ...
        NavigationView{
            ...
            VStack{
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[1].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[2].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[3].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[4].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[5].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[6].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[7].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[8].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
