        ...
        NavigationView{
            ...
            VStack{
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[17].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[18].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[19].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[20].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[21].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[22].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[23].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
                ...
                HStack{
                    ...
                    Spacer()
                    Text("\((weather.list[24].pop)*100)"+"%").foregroundColor(Color.black).font(.system(size: 15)).bold()
                    Spacer()
